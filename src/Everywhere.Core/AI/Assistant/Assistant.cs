...
public abstract partial class Assistant : ObservableValidator, IModelDefinition
{
    ...
    [SettingsItem(IsVisibleBindingPath = nameof(SupportsTemperature), Group = AbstractionsLocaleKey.Common_Advanced)]
    ...
    [SettingsItem(IsVisibleBindingPath = nameof(IsOpenAI), Group = AbstractionsLocaleKey.Common_Advanced)]
    ...
    [SettingsItem(IsVisibleBindingPath = nameof(IsOpenAIResponses), Group = AbstractionsLocaleKey.Common_Advanced)]
    [SettingsItems(IsExpanded = false)]
    ...
    [SettingsItem(IsVisibleBindingPath = nameof(IsAnthropic), Group = AbstractionsLocaleKey.Common_Advanced)]
    [SettingsItems(IsExpanded = false)]
    ...
    [SettingsItem(IsVisibleBindingPath = nameof(IsGoogle), Group = AbstractionsLocaleKey.Common_Advanced)]
    [SettingsItems(IsExpanded = false)]
