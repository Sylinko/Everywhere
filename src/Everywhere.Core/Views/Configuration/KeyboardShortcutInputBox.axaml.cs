...
public class KeyboardShortcutInputBox : TemplatedControl
{
    ...
    public static readonly StyledProperty<IShortcutListener?> ShortcutListenerProperty =
        AvaloniaProperty.Register<KeyboardShortcutInputBox, IShortcutListener?>(nameof(ShortcutListener));

    public IShortcutListener? ShortcutListener
    {
        get => GetValue(ShortcutListenerProperty);
        set => SetValue(ShortcutListenerProperty, value);
    }

    public static readonly StyledProperty<bool> IsReadOnlyProperty =
        AvaloniaProperty.Register<KeyboardShortcutInputBox, bool>(nameof(IsReadOnly));
    ...
    protected override void OnPointerReleased(PointerReleasedEventArgs e)
    {
        ...
        if (ShortcutListener is not { } shortcutListener) return;
        ...
        _shortcutScope = shortcutListener.StartCaptureKeyboardShortcut();
